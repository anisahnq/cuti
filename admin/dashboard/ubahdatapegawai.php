...
<head>
	...
	<title>Ubah Data Pegawai - Sistem Cuti Online</title>
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                      <form class="form-horizontal" role="form" method="post" action="updatepegawai.php">
                        <?php
                        ...
                        <div class="col-sm-10">
                          <input type="password" name="password" class="form-control" placeholder="Password" required value="<?php echo $data['password']; ?>">
												...
												<div class="col-sm-10">
													<input type="text" name="nama" class="form-control" placeholder="Nama Lengkap" required value="<?php echo $data['nama_pegawai']; ?>">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Jabatan:</label>
												<div class="col-sm-10">
													<input type="text" name="jabatan" class="form-control" placeholder="Jabatan" required value="<?php echo $data['jabatan_pegawai']; ?>">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Alamat:</label>
												<div class="col-sm-10">
													<textarea type="text" name="alamat" class="form-control" placeholder="Alamat" required><?php echo $data['alamat_pegawai']; ?></textarea>
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Telepon:</label>
												<div class="col-sm-10">
													<input type="number" name="telepon" class="form-control" placeholder="Telefon" required value="<?php echo $data['no_telfon_pegawai']; ?>">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Izin:</label>
												<div class="col-sm-10">
													<input type="number" name="izin" class="form-control" placeholder="Izin" required min="1" max="5" value="<?php echo $data['izin']; ?>">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Sakit:</label>
												<div class="col-sm-10">
													<input type="number" name="sakit" class="form-control" placeholder="Sakit" required min="1" max="5" value="<?php echo $data['sakit']; ?>">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Alpha:</label>
												<div class="col-sm-10">
													<input type="number" name="alpha" class="form-control" placeholder="Alpha" required min="1" max="5" value="<?php echo $data['alpha']; ?>">
												</div>
												</div>
												<div class="form-group">
