...
<head>
	...
	<title>Tambah Pegawai - Sistem Cuti Online</title>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Tambah Data Pegawai</a>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                      <form class="form-horizontal" role="form" method="post" action="insertpegawai.php">
                        <div class="form-group">
                        <label class="control-label col-sm-2">ID Pegawai:</label>
                        <div class="col-sm-10">
                          <input type="text" name="id_pegawai" class="form-control" placeholder="Auto Generated" readonly>
                        </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" name="password" class="form-control" placeholder="Password" required>
												...
												<div class="col-sm-10">
													<input type="number" name="telepon" class="form-control" placeholder="Telefon" required>
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Izin:</label>
												<div class="col-sm-10">
													<input type="number" name="izin" class="form-control" placeholder="Izin" required min="1" max="5">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Sakit:</label>
												<div class="col-sm-10">
													<input type="number" name="sakit" class="form-control" placeholder="Sakit" required min="1" max="5">
												</div>
												</div>
												<div class="form-group">
												<label class="control-label col-sm-2">Alpha:</label>
												<div class="col-sm-10">
													<input type="number" name="alpha" class="form-control" placeholder="Alpha" required min="1" max="5">
												</div>
												</div>
												<div class="form-group">
