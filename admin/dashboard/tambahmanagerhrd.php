...
<head>
	...
	<title>Tambah Manager HRD - Sistem Cuti Online</title>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Tambah Data Manager HRD</a>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                      <form class="form-horizontal" role="form" method="post" action="insertmanagerhrd.php">
                        <div class="form-group">
                        <label class="control-label col-sm-2">ID Manager HRD:</label>
                        <div class="col-sm-10">
                          <input type="text" name="id_managerhrd" class="form-control" placeholder="Auto Generated" readonly>
                        </div>
                        </div>
                        <div class="form-group">
