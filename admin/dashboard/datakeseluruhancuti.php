...
<head>
	...
	<title>Keseluruhan Data Cuti - Sistem Cuti Online</title>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Keseluruhan Data Cuti</a>
                </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
											<a href="laporancuti.php" class="btn btn-primary btn-fill" role="button" target="_blank">Laporan Keseluruhan Cuti</a>
...
FROM managerhrd a, pegawai b, permohonan c WHERE a.id_managerhrd=c.id_managerhrd AND b.id_pegawai=c.id_pegawai");
													...
													<tr style="text-align:center;">
														...
														<td><a href="cetakcuti.php?id_pegawai=<?php echo $data['idpeg'];?>&kd_cuti=<?php echo $data['kdct'];?>" target="_blank" class="red-text">Cetak</a></td>
													</tr>
													<?php } ?>
												</tbody>
											</table>
