                    ...
                    <div class="col-md-12">
											<table width="70%" height="300px">
												...
												<tr>
													...
													<td>: <?php echo $data['id_pegawai']; ?><br><hr></td>
												</tr>
												<tr>
													<td>Nama Pegawai<br><hr></td>
													<td>: <?php echo $data['nama_pegawai']; ?><br><hr></td>
												</tr>
												<tr>
													<td>Jabatan Pegawai<br><hr></td>
													<td>: <?php echo $data['jabatan_pegawai']; ?><br><hr></td>
												</tr>
												<tr>
													<td>Alamat Pegawai<br><hr></td>
													<td>: <?php echo $data['alamat_pegawai']; ?><br><hr></td>
												</tr>
												<tr>
													<td>Telepon<br><hr></td>
													<td>: <?php echo $data['no_telfon_pegawai']; ?><br><hr></td>
												</tr>
												<?php } ?>
											</table>
